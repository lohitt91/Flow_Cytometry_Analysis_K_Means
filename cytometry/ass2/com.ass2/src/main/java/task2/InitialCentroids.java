...
/*		return env.fromElements(new Tuple4<Integer, Double, Double, Double>(1, ly6c[0], cd11b[0], sca1[0]),
		...
		return env.fromElements(new Centroid(1, ly6c[0], cd11b[0], sca1[0], count),
				new Centroid(2, ly6c[1], cd11b[1], sca1[1], count),
				new Centroid(3, ly6c[2], cd11b[2], sca1[2], count),
				new Centroid(4, ly6c[3], cd11b[3], sca1[3], count));
				//new Centroid(5, ly6c[4], cd11b[4], sca1[4], count));
